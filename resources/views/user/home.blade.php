...
@section('content')
    ...
    <section class="container py-5 text-center">
        <div class="row row-cols-1 row-cols-lg-2 justify-content-center">
            ...
            <div class="col col-lg-4">
                <div class="row row-cols-1 border border-1 rounded shadow ms-1 pb-3 mt-sm-3 ms-sm-0">
                    <div class="instagram-embed hide-scrollbar px-0">
                        <h3 class="title-style text-start mb-lg-5 mb-4 ps-4-5">ROJOKU <span>INSTAGRAM</span></h3>
                        <div class="col">
    ...
    <section class="container pt-5">
        <div class="row row-cols-1 row-cols-lg-2 justify-content-center">
            <div class="col col-lg-8">
                <div class="rounded shadow border border-1">
                    <div class="row mx-auto">
                        <h3 class="title-style text-start mb-lg-5 mb-4"><span>BERITA & </span>PENGUMUMAN</h3>
                    </div>
                    <!-- berita dan pengumuman -->
                    <div class="row row-cols-1 pb-3 mx-auto mx-sm-0">
                        <div class="berita-pengumuman hide-scrollbar">
                            <div class="col">
            ...
            <div class="col col-lg-4">
                <div class="row row-cols-1 border border-1 rounded shadow ms-1 pb-3 mt-sm-3 ms-sm-0">
                    <div class="youtube-embed hide-scrollbar px-0">
                        <h3 class="title-style text-start mb-lg-5 mb-4 ps-4-5">ROJOKU <span>YOUTUBE</span></h3>
                        <div class="col">
    ...
    <section class="w3l-news container py-5">
        <div class="row">
            <div class="col">
                <div class="shadow rounded border border-1">
                    <div class="row mx-auto">
                        <h3 class="title-style text-start mb-lg-5 mb-4">BUSINESS CLASS <span>INFORMATION</span></h3>
                    </div>
                    ...
                    <nav>
                        <ul class="pagination-info justify-content-center mx-auto my-3">
                        </ul>
                    </nav>
                </div>
            </div>
