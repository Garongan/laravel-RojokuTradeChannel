...
<section class="py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <a href="/admin/bisnis-class" class="btn btn-primary">
                ...
                <form action="/admin/bisnis-class/{{ $bisnisClass->slug }}/edit" method="get" class="d-inline">
                    @csrf
                ...
                <form action="/admin/bisnis-class/{{ $bisnisClass->slug }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
                    <button class="btn btn-danger" onclick="return confirm('Are you sure to delete this bisnis class?')">
