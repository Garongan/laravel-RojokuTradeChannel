                  ...
                  <div class="row tm-edit-product-row">
                    <div class="col-xl-6 col-lg-6 col-md-12">
                      <form action="/admin/dashboard" class="tm-edit-product-form">
                        <div class="form-group mb-3">
                          ...
                          <input id="produk-name" name="produk-name" type="text" class="form-control" placeholder="Lorem" required/>
                        </div>
                        <div class="form-group mb-3">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                      <div class="tm-product-img-edit mx-auto">
                        <img src="/assets/images/s1.jpg" alt="Product image" class="img-fluid d-block mx-auto">
