                            ...
                            <table class="table table-hover">
                                <tbody id="produk-list-dashboard">
                                    ...
                                    <tr>
                                        ...
                                        <!-- img thumbnail -->
                                        <td>
                                            <img src="/assets/images/{{ $item->img_name }}.jpg" class="img-thumbnail p-0" alt="" style="max-height: 50px">
                                        </td>
                                        <!-- /img thumbnail -->
                                        ...
                                        <td>
                                            ...
                                            {{-- edit --}}
                                            <a href="/admin/{{ $item->id }}/edit" class="badge bg-warning">
                                            ...
                                            {{-- delete --}}
                                            <a href="/admin/produk/{{ $item->id }}" class="badge bg-danger">
