        ...
        <div class="row">
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="/admin/produk/{{ $produk->slug }}/edit" method="get" class="d-inline">
                        @csrf
                    ...
                    <form action="/admin/produk/{{ $produk->slug }}" method="post" class="d-inline">
                        @method('delete')
                        @csrf
            ...
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="{{ asset('/storage/'.$produk->img_name1) }}" alt="Product Image 1" id="product-detail">
                </div>
                <div class="row me-1">
                    <!--Start Controls-->
                    ...
                    <div id="multi-item-example" class="col-10 ps-4 carousel slide carousel-multi-item" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#"><img class="produk-img img-fluid col-4" src="{{ asset('/storage/'.$produk->img_name2) }}" alt="Product Image 2"></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#"><img class="produk-img img-fluid col-4" src="{{ asset('/storage/'.$produk->img_name3) }}" alt="Product Image 3"></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#"><img class="produk-img img-fluid col-4" src="{{ asset('/storage/'.$produk->img_name4) }}" alt="Product Image 4"></a>
                                    </div>
                                </div>
                            </div>
                            <!--/.First slide-->
